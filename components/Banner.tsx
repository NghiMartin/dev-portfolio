  ...
  return (
    <div className="flex flex-row items-center justify-center px-20 mt-[100px] z-[20] ">
      <div className="flex flex-col  justify-center  text-center">
        ...
        Enthusiastic Front-End Engineer focusing on React Native, eager to learn and build clean and user-friendly mobile applications.
        </p>
        <div className="text-md flex justify-center">
          <button
            onClick={() => window.open("mailto:soobinnghi@gmail.com")}
